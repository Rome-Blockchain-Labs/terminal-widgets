  ...
  return (
    <div className=" flex flex-col bg-black h-full w-full px-2 py-3">
      ...
      <section className="text-white flex flex-col gap-y-2 overflow-auto p-4 mt-10">
        ...
        <p>Welcome to Rome Terminal!</p>

        <p>
          These terms and conditions outline the rules and regulations for the use of Rome Terminal's Website, located
          at https://app.rometerminal.io.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use Rome
          Terminal if you do not agree to take all of the terms and conditions stated on this page.
        </p>
        ...
        <p>
          We employ the use of cookies. By accessing Rome Terminal, you agreed to use cookies in agreement with the Rome
          Terminal's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Rome Terminal and/or its licensors own the intellectual property rights for all
          material on Rome Terminal. All intellectual property rights are reserved. You may access this from Rome
          Terminal for your own personal use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Rome Terminal</li>
          <li>Sell, rent or sub-license material from Rome Terminal</li>
          <li>Reproduce, duplicate or copy material from Rome Terminal</li>
          <li>Redistribute content from Rome Terminal</li>
        </ul>
        ...
        <p>
          ...
          areas of the website. Rome Terminal does not filter, edit, publish or review Comments prior to their presence
          on the website. Comments do not reflect the views and opinions of Rome Terminal,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, Rome Terminal shall not be liable for the Comments or for any liability, damages
          or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
          Comments on this website.
        </p>

        <p>
          Rome Terminal reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>
          You hereby grant Rome Terminal a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>
          ...
          records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Rome
          Terminal; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to Rome Terminal. Please include your name, your organization name,
        ...
        <p>
          No use of Rome Terminal's logo or other artwork will be allowed for linking absent a trademark license
          agreement.
        </p>
