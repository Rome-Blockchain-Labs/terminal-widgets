...
const Registration = ({
  ...
  return (
    <div className="font-roboto  ">
      <form onSubmit={onSubmit} className="wg:grid wg:grid-cols-2 gap-4">
        <div>
        ...
        <button
          type="submit"
          className="col-span-2 mt-[11px] h-[47px] w-full rounded-md bg-november text-sour hover:bg-midnight hover:text-white "
        >
          Continue
        </button>
      </form>
      ...
      <button
        ...
        className="w-full  mt-2 text-sm hover:underline  text-center underline-offset-4"
      >
        Forgot your password?
      </button>
      <button
        onClick={() => setIsLoginPage(true)}
        className="w-full mt-4 text-base hover:underline  underline-offset-4"
      >
