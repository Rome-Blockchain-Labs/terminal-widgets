...
const NormalEllipsisedNumFont = styled(NumFont)`
...
const EnlargedEllipsisedNumFont = styled(NumFont)`
  vertical-align: middle;
  display: inline-block;
  white-space: nowrap;
  overflow: hidden;
...
const EllipsisedNumFont = withEnlargedProps(
  NormalEllipsisedNumFont,
  EnlargedEllipsisedNumFont
);
...
const AlternatingColorRow = styled.tr<any>`
  ${(props) => (props.index % 2 ? 'background-color:#004B4E;' : '')}
  ${(props) =>
