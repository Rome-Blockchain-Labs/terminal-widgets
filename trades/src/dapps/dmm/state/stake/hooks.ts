...
export interface StakingInfo {
  ...
  // the amount of reward token earned by the networkLogos account, or undefined if no account
  earnedAmount: TokenAmount;
  // the total amount of token staked in the contract
  totalStakedAmount: TokenAmount;
  // the amount of token distributed per second to all LPs, constant
  totalRewardRate: TokenAmount;
  // the current amount of token distributed to the networkLogos account per second.
  // equivalent to percent of total supply * reward rate
  rewardRate: TokenAmount;
  // when the period ends
  periodFinish: Date | undefined;
  // calculates a hypothetical amount of token distributed to the networkLogos account per second.
    ...
    () =>
      chainId
        ? STAKING_REWARDS_INFO[
            chainId as keyof typeof STAKING_REWARDS_INFO
