...
async function fetchChunk(
  ...
  return { blockNumber: resultsBlockNumber.toNumber(), results: returnData };
}
...
export function activeListeningKeys(
  allListeners: AppState['dapps']['dmm']['multicall']['callListeners'],
  chainId?: number
...
export function outdatedListeningKeys(
  callResults: AppState['dapps']['dmm']['multicall']['callResults'],
...
export default function Updater(): null {
  ...
  const state = useSelector<AppState, AppState['dapps']['dmm']['multicall']>(
    (state) => state.dapps.dmm.multicall
  );
