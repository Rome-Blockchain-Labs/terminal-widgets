...
export function useSwapState(): AppState['dapps']['dmm']['swap'] {
  return useSelector<AppState, AppState['dapps']['dmm']['swap']>(
    (state) => state.dapps.dmm.swap
  );
}
...
export function useDefaultsFromURLSearch():
  ...
  useEffect(() => {
    ...
    const outputCurrencyAddress = [
      ...
      ? KNC[chainId as keyof typeof KNC].address
    ...
    dispatch(
      replaceSwapState({
        ...
        outputCurrencyId:
          parsed[Field.OUTPUT].currencyId || outputCurrencyAddress,
