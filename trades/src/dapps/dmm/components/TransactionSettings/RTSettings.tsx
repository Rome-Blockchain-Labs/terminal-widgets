...
const Option = styled(FancyButton)<{ active: boolean }>`
  ...
  ${({ active }) =>
    active &&
    tw`bg-green-400 text-black border-green-400 outline-none focus:border-green-400 hover:border-green-400`};
`;

const Input = styled.input`
  ${tw`bg-green-700 text-xl`}
...
const OptionCustom = styled(FancyButton)<{
  ...
  padding: 0 0.75rem;
  flex: 1;
  ${({ active, theme, warning }) => active && tw`border border-gray-300`}
