...
export const INIT_CODE_HASH =
  '0xf6eae63ebbc500de6e7310fc6568df4e6a4514aac0d3d423da5e4e3f332d04f5';
export const BAD_RECIPIENT_ADDRESSES: string[] = [
  FACTORY_ADDRESSES[ChainId.MAINNET],
  ROUTER_ADDRESSES[ChainId.MAINNET],
];
...
export const DMM_ANALYTICS_URL: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AVAXMAINNET]:
    KYBER_MAINNET_ENV === 'staging'
      ? ''
      : 'https://avax-analytics.kyberswap.com',
  [ChainId.FANTOM]:
    KYBER_MAINNET_ENV === 'staging'
...
export const USDC: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.ROPSTEN]: new Token(
    ChainId.ROPSTEN,
    '0x068B43f7F2f2c6a662C36E201144aE45f7a1C040',
    6,
    'USDC',
    'USD Coin'
  ),
  ...
  [ChainId.MUMBAI]: new Token(
    ChainId.MUMBAI,
    '0x2CeC76B26A8d96BF3072D34A01BB3a4edE7c06BE',
    6,
    'USDC',
    'USD Coin'
  ),
...
export const USDT: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.ROPSTEN]: new Token(
    ChainId.ROPSTEN,
    '0x65Bd1F48f1dd07bb285a3715c588F75684128acE',
    6,
    'USDT',
    'Tether USD'
  ),
  ...
  [ChainId.MUMBAI]: new Token(
    ChainId.MUMBAI,
    '0x064B91Bda6d178DfE03835de9450BFe78201c43F',
    6,
    'USDT',
    'Tether USD'
  ),
...
export const BLOCKS_PER_YEAR: { [chainId in ChainId]: number } = {
  [ChainId.MAINNET]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.MAINNET]) * 60 * 24 * 365
  ),
  [ChainId.RINKEBY]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.RINKEBY]) * 60 * 24 * 365
  ),
  [ChainId.ROPSTEN]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.ROPSTEN]) * 60 * 24 * 365
  ),
  [ChainId.GÖRLI]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.GÖRLI]) * 60 * 24 * 365
  ),
  [ChainId.KOVAN]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.KOVAN]) * 60 * 24 * 365
  ),
  [ChainId.MATIC]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.MATIC]) * 60 * 24 * 365
  ),
  [ChainId.MUMBAI]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.MUMBAI]) * 60 * 24 * 365
  ),
  [ChainId.BSCTESTNET]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.BSCTESTNET]) * 60 * 24 * 365
  ),
  [ChainId.BSCMAINNET]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.BSCMAINNET]) * 60 * 24 * 365
  ),
  [ChainId.AVAXTESTNET]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.AVAXTESTNET]) * 60 * 24 * 365
  ),
  [ChainId.AVAXMAINNET]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.AVAXMAINNET]) * 60 * 24 * 365
  ),
  [ChainId.FANTOM]: Math.floor(
    (60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.FANTOM]) * 60 * 24 * 365
  ),
};
...
export const KNCL_ADDRESS_ROPSTEN =
...
export const ROPSTEN_TOKEN_LOGOS_MAPPING: {
  ...
  '0x068b43f7f2f2c6a662c36e201144ae45f7a1c040':
    '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48',
  '0x3dff0dce5fc4b367ec91d31de3837cf3840c8284':
    '0x2260fac5e5542a773aa44fbcfedf7c193bc2c599',
  '0x5f4f41e067e8ccf0d1f9ee007223af4d72990cdc':
    '0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9',
  '0x65bd1f48f1dd07bb285a3715c588f75684128ace':
    '0xdac17f958d2ee523a2206206994597c13d831ec7',
  '0x787e7339a52d7784a22146da7209c702e1e38511':
    '0xc00e94cb662c3520282e6f5717214004a7f26888',
  '0x7b2810576aa1cce68f2b118cef1f36467c648f92':
    '0xdd974d5c2e2928dea5f71b9825b8b646686bd200',
  '0x8b4ddf9f13f382aff76d262f6c8c50e6d7961b94':
    '0xdefa4e8a7bcba345f687a2f1456f5edd9ce97202',
  '0xa748593dd74e5d0bb38a3f2f5090a0f31370c574':
...
export const FAIRLAUNCH_ADDRESSES: { [chainId in ChainId]: string[] } = {
  ...
  [ChainId.MATIC]:
    KYBER_MAINNET_ENV === 'staging'
      ? [
          '0xf530a090EF6481cfB33F98c63532E7745abab58A',
          '0xF13A25d05898530b5615698aa98D76684914aEdB',
        ]
      : [
...
export const FARMING_POOLS: { [chainId in ChainId]: string[] } = {
  ...
  [ChainId.MUMBAI]: [
    '0x967a889dbF977DD9c7b79BF422f5Fa50294e56FD',
    '0x801Da4b550D1645F7aD3De8A5349a51B8dea48b8',
  ],
  [ChainId.BSCTESTNET]: [
  ...
  [ChainId.AVAXTESTNET]: [
    '0x2b4b833864f75fc23f96b5a0cbde8a4046c710b6',
    '0x0cfc06499dab780aab7775dc260117ec5ca106b4',
  ],
  [ChainId.AVAXMAINNET]: [
    '0xe1dAd9E06380bC8962e259dDd6a5257A4f56d525',
    '0x0f0FC5a5029E3d155708356b422D22Cc29f8b3D4',
...
export const KYBER_NETWORK_DISCORD_URL =
  'https://discord.com/invite/NB3vc8J9uv';
...
export const CREATE_POOL_AMP_HINT =
  'Stands for amplification factor. Pools with a higher AMP provide higher capital efficiency within a particular price range. We recommend higher AMP for stable token pairs and lower AMP for volatile token pairs';
