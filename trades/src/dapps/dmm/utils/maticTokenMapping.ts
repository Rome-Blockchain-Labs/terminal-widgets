...
export const getMaticTokenLogoURL = (address: string) => {
  ...
  if (address?.toLowerCase() === ZERO_ADDRESS) {
    //native token
    uri =
      'https://raw.githubusercontent.com/dynamic-amm/dmm-interface/main/src/assets/networks/polygon-network.png';
  }
  if (address?.toLowerCase() === '0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270') {
    ...
    KYBER_MAINNET_ENV === 'production' &&
    address?.toLowerCase() === '0x1c954e8fe737f99f68fa1ccda3e51ebdb291948c'
  ) {
    address = '0xdeFA4e8a7bcBA345F687a2f1456F5Edd9CE97202';
  } else if (
    address?.toLowerCase() === '0x8f3cf7ad23cd3cadbd9735aff958023239c6a063'
  ) {
    ...
    address?.toLowerCase() === '0xb33eaad8d922b1083446dc23f610c2567fb5180f'
  ) {
    address = '0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984';
  } else if (
    address?.toLowerCase() === '0xdb3b3b147a030f032633f6c4bebf9a2fb5a882b5'
  ) {
    uri =
      'https://raw.githubusercontent.com/sameepsi/quickswap-interface/master/assets/easyfi-token.png';
  } else if (
    address?.toLowerCase() === '0x831753dd7087cac61ab5644b308642cc1c33dc13'
  ) {
    uri =
      'https://raw.githubusercontent.com/sameepsi/quickswap-interface/master/public/favicon.jpeg';
  } else if (
    address?.toLowerCase() === '0x1bfd67037b42cf73acf2047067bd4f2c47d9bfd6'
  ) {
    address = '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599';
  } else if (
    address?.toLowerCase() === '0x385eeac5cb85a38a9a07a70c73e0a3271cfb54a7'
  ) {
    uri = 'https://etherscan.io/token/images/AavegotchiGHST_32.png';
  } else if (
    address?.toLowerCase() === '0x4ebde54ba404be158262ede801744b92b9878c61'
  ) {
    uri =
      'https://raw.githubusercontent.com/sameepsi/quickswap-interface/master/assets/easyfi-token.png';
  } else if (
    address?.toLowerCase() === '0xa1c09c8f4f5d03fcc27b456475d53d988e98d7c5'
  ) {
    uri =
      'https://raw.githubusercontent.com/sameepsi/quickswap-interface/master/assets/easyfi-token.png';
  } else if (
    address?.toLowerCase() === '0xfc39742fe9420a7af23757fc7e78d1c3ae4a9474'
  ) {
    uri =
      'https://raw.githubusercontent.com/sameepsi/quickswap-interface/master/assets/easyfi-token.png';
  } else if (
    address?.toLowerCase() === '0x9f5755d47fb80100e7ee65bf7e136fca85dd9334'
  ) {
    uri = 'https://etherscan.io/token/images/om_32.png';
  } else if (
    address?.toLowerCase() === '0x9719d867a500ef117cc201206b8ab51e794d3f82'
  ) {
    ...
    address?.toLowerCase() === '0xe6fc6c7cb6d2c31b359a49a33ef08ab87f4de7ce'
  ) {
    uri =
      'https://assets.coingecko.com/coins/images/7697/small/N7aEdYrY_400x400.png?1561587437';
  } else if (
    address?.toLowerCase() === '0x53e0bca35ec356bd5dddfebbd1fc0fd03fabad39'
  ) {
    address = '0x514910771AF9Ca656af840dff83E8264EcF986CA';
  } else if (
    address?.toLowerCase() === '0x71b821aa52a49f32eed535fca6eb5aa130085978'
  ) {
    address = '0xB6eD7644C69416d67B522e20bC294A9a9B405B31';
  } else if (
    address?.toLowerCase() === '0xa1c57f48f0deb89f569dfbe6e2b7f46d33606fd4'
  ) {
    address = '0x0F5D2fB29fb7d3CFeE444a200298f468908cC942';
  } else if (
    address?.toLowerCase() === '0x8505b9d2254a7ae468c0e9dd10ccea3a837aef5c'
  ) {
    ...
    address?.toLowerCase() === '0xda537104d6a5edd53c6fbba9a898708e465260b6'
  ) {
    address = '0x0bc529c00C6401aEF6D220BE8C6Ea1667F6Ad93e';
  } else if (
    address?.toLowerCase() === '0x7ceb23fd6bc0add59e62ac25578270cff1b9f619'
  ) {
    ...
    address?.toLowerCase() ===
    '0x3Dc7B06dD0B1f08ef9AcBbD2564f8605b4868EEA'.toLowerCase()
  ) {
    uri = 'https://s2.coinmarketcap.com/static/img/coins/64x64/13532.png';
  } else if (
    address?.toLowerCase() ===
    '0x3A3e7650f8B9f667dA98F236010fBf44Ee4B2975'.toLowerCase()
  ) {
    uri = 'https://xdollar.mcn.ventures/xusd-icon.png';
  } else if (
    address?.toLowerCase() ===
    '0xfAdE2934b8E7685070149034384fB7863860D86e'.toLowerCase()
  ) {
    uri = 'https://i.imgur.com/PyipL43.png';
  } else if (
    address?.toLowerCase() ===
    '0xbD1463F02f61676d53fd183C2B19282BFF93D099'.toLowerCase()
  ) {
    uri = 'https://i.imgur.com/EknGhAl.png';
  } else if (
    address?.toLowerCase() ===
    '0xc1c93D475dc82Fe72DBC7074d55f5a734F8cEEAE'.toLowerCase()
  ) {
    // PGX
    uri =
