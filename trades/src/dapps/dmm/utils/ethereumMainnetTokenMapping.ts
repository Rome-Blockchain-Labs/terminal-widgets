...
export const getEthereumMainnetTokenLogoURL = (address: string) => {
  ...
  if (address?.toLowerCase() === ZERO_ADDRESS) {
    ...
    address?.toLowerCase() ===
    '0xd7DCd9B99787C619b4D57979521258D1A7267ad7'.toLowerCase()
  ) {
    //EVRY
    uri = 'https://s2.coinmarketcap.com/static/img/coins/64x64/11458.png';
  } else if (
    address?.toLowerCase() ===
    '0x656C00e1BcD96f256F224AD9112FF426Ef053733'.toLowerCase()
  ) {
    //EFI
    uri = 'https://s2.coinmarketcap.com/static/img/coins/64x64/8985.png';
  } else if (
    address?.toLowerCase() ===
    '0x0C0F2b41F758d66bB8e694693B0f9e6FaE726499'.toLowerCase()
  ) {
    // UND
    uri = 'https://s2.coinmarketcap.com/static/img/coins/64x64/7848.png';
  } else if (
    address?.toLowerCase() === '0x60ef10edff6d600cd91caeca04caed2a2e605fe5'
  ) {
    // MOCHI INU
