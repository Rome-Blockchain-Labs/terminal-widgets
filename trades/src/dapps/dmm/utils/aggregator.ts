  ...
  public static async bestTradeExactIn(
    ...
    if (tokenInAddress && tokenOutAddress) {
      ...
      try {
        ...
        const toCurrencyAmount = function (
          value: string,
          currency: Currency
        ): CurrencyAmount {
        ...
        const inputAmount = toCurrencyAmount(
          result.inputAmount,
        ...
        const priceImpact =
          ((-result.amountOutUsd + result.amountInUsd) * 100) /
          result.amountInUsd;
  ...
  public static async compareDex(
    ...
    if (
      ...
      try {
        ...
        const outputAmount = toCurrencyAmount(
