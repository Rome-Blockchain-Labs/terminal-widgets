...
const TabContainer = styled.div`
  ${tw`z-10 text-black absolute  bottom-8 left-0 right-0 mx-auto md:bottom-auto md:right-auto w-1/2 md:left-8 md:top-8 lg:left-0 lg:mx-auto  lg:right-0  grid grid-cols-2 rounded-full bg-gray-400 h-11 px-1 gap-x-2 max-w-xs`}
`;
