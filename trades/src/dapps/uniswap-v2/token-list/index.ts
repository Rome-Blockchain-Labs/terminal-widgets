...
import SERENDALE_DEFAULT_TOKEN_LIST_OF_LISTS from './klaytn/serendale';
...
const KLAYTN_TOKEN_LIST_URLS_MAP: ExchangeTokenListUrlsMap = {
  SERENDALE: SERENDALE_DEFAULT_TOKEN_LIST_OF_LISTS,
};
...
export const NETWORK_EXCHANGE_TOKEN_LIST_URLS_MAP: NetworkExchangeTokenListUrlsMap =
  {
    ...
    KLAYTN: KLAYTN_TOKEN_LIST_URLS_MAP,
