...
export const BeamSwap: FC<IIconProps> = ({ active, height, width }) => {
    ...
    >
      <g opacity="0.2">
        ...
        <path
          ...
          fill={active ? `url(#BEAMSWAP_BG_1_${uuid.current})` : '#B4BBC7'}
          fillRule="evenodd"
        />
      </g>
      <linearGradient
      ...
      <TransitionPath
        ...
        fill={active ? `url(#BEAMSWAP_BG_2_${uuid.current})` : '#B4BBC7'}
        fillRule="evenodd"
      />
      <g opacity="0.5">
        <linearGradient
        ...
        <path
          ...
          fill={active ? `url(#BEAMSWAP_BG_3_${uuid.current})` : '#B4BBC7'}
          fillRule="evenodd"
        />
      </g>
      <g opacity="0.4">
        ...
        <TransitionPath
          ...
          fill={active ? `url(#BEAMSWAP_BG_4_${uuid.current})` : '#B4BBC7'}
          fillRule="evenodd"
        />
      </g>
      <TransitionPath
