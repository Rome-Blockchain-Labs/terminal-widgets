    ...
    >
      <g>
        <TransitionPath
          ...
          fill={active ? '#3C1A26' : '#222222'}
        />
        <TransitionPath
          d="M699.1,907.5L450.3,762.9l-0.3-91.7l248.9,144.6L699.1,907.5z"
          fill={active ? '#29121A' : '#171717'}
        />
        <TransitionPath
          d="M698.10,815.8L450,671.2l140.8-81.3l248.9,144.6L698.9,815.8z"
          fill={active ? '#421D2A' : '#D6D6D6'}
        />
        <TransitionPath
