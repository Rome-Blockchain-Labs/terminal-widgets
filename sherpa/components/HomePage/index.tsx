...
const Home = () => {
  ...
  return (
    <div className="grid w-screen h-screen place-items-center">
      <div className="bg-cover bg-sherpa-bg w-full aspect-[16/10] flex justify-center items-stretch px-[6.5%] py-[4.4%] gap-[15px] max-w-5xl">
        ...
        <div className="min-h-[247px] rounded-md w-1/2 backdrop-filter backdrop-blur-md bg-[#24466D] bg-opacity-50  px-[3.5%] py-[2%] ">
          <div className="flex">
            <div className="text-white text-[2.4vw] font-bold">STATISTICS</div>
            <div className="ml-auto">
              <div className="rounded-[4px]  bg-primary text-secondary p-[6px] text-[2.4vw] font-bold">
                {selectedContract.val}
              </div>
            </div>
          </div>
          <div className="flex mt-2">
            <span className="text-[2.3vw] text-white">Anonymity Set</span>
            <InformationCircleIcon className="w-2 h-2 mb-2 text-white" />
            <div className="text-[1.7vw] text-white ml-auto mr-[0.5]">AVAX</div>
          </div>

          <div className="flex items-center mt-1">
            <div className="rounded-[4px]  bg-primary text-secondary py-[4px] px-[11px] text-[2.2vw] font-bold">
              {totalDeps}
            </div>
            <span className="text-[1.9vw] ml-[5px] text-white">
              equal user deposits
            </span>
          </div>

          <div className="text-[2vw] text-white mt-[12px]">Anonymity Set</div>
          <div className="grid grid-cols-2 grid-rows-6 grid-flow-col gap-y-[1.3vw] mt-1 md:grid-rows-8">
            {events &&
