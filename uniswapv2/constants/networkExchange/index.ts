  ...
  switch (network) {
    case NetworkName.AVALANCHE:
      ...
      if (exchange === ExchangeType.TRADERJOE) {
        avalancheBasePair.address = '0xeD8CBD9F0cE3C6986b22002F03c6475CEb7a6256'
      } else if (exchange === ExchangeType.PANGOLIN) {
        avalancheBasePair.address = '0xe28984e1EE8D431346D32BeC9Ec800Efb643eef4'
      } else if (exchange === ExchangeType.DMM) {
        avalancheBasePair.address = '0x8BcBc65Ce330BC019D87409C2949A2471Bef1E5C' //todo this is a pool, not a pair, there could be multiple pools
      } else {
        throw new Error(
    ...
    case NetworkName.MOONRIVER:
      ...
      if (exchange === ExchangeType.SOLARBEAM) {
        moonriverBasePair.address = '0x2cc54b4A3878e36E1C754871438113C1117a3ad7'
      }
