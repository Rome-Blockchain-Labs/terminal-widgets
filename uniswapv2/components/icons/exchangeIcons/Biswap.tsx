    ...
    return (
      ...
      >
        ...
        <TransitionPath
          ...
          fill={grayscale ? '#B4BBC7' : `url(#BISWAP_LG_1_${uuid.current})`}
        />
        <TransitionPath
          ...
          fill={grayscale ? '#B4BBC7' : `url(#BISWAP_LG_2_${uuid.current})`}
        />
        <defs>
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id={`BISWAP_LG_1_${uuid.current}`}
            x1="43.3371"
            x2="36.9491"
            y1="17.2788"
            y2="52.4708"
          >
            <stop stopColor={grayscale ? '#B4BBC7' : '#FF496A'} />
            <stop offset="1" stopColor={grayscale ? '#B4BBC7' : '#E42648'} />
          </linearGradient>
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id={`BISWAP_LG_2_${uuid.current}`}
            x1="13.0692"
            x2="27.193"
            y1="39.8859"
            y2="-1.0612e-05"
          >
            <stop
              offset="0.00181229"
              stopColor={grayscale ? '#B4BBC7' : '#1158F1'}
            />
            <stop offset="1" stopColor={grayscale ? '#B4BBC7' : '#119BED'} />
          </linearGradient>
        </defs>
      </svg>
    );
