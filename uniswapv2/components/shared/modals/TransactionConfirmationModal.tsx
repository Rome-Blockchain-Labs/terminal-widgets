...
import { AlertTriangle, ArrowUpCircle, ExternalLink } from 'react-feather'
...
import { CloseButton, ButtonPrimary } from '../buttons'
...
export function TransactionConfirmationModal({
  ...
  // confirmation screen
  return (
    <ModalWrapper isOpen={isOpen} noPadding={noPadding} onDismiss={onDismiss}>
      {attemptingTxn ? (
