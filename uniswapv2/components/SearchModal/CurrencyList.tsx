import { LinkStyledButton } from 'components/shared/buttons'
import Column from 'components/shared/column'
import { RowFixed } from 'components/shared/row'
import TokenSymbol from 'components/shared/TokenSymbol'
import { MouseoverTooltip } from 'components/shared/tooltip'
...
import { WrappedTokenInfo } from 'types/tokenList'
import {
  Currency,
  Token,
  ETHER,
...
import { isTokenOnList } from 'utils/dapp'
import { getDefaultCurrencySymbol } from 'utils/getDefaultCurrencySymbol'
...
export default function CurrencyList({
  ...
  const itemKey = useCallback(({ columnIndex, data, rowIndex }: any) => {
