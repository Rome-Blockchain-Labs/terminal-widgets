...
import { TokenAddressMap } from 'types/tokenList'
import { Percent, CurrencyAmount, Currency, ETHER, Token } from 'uniV2ClonesSDK'

import {
  getBlockExplorerUrlForChainId,
  NetworkChainId,
...
export function getExplorerLink(
  ...
  const prefix = getBlockExplorerUrlForChainId(chainId)
...
export function getRouterContract(
  ...
  return getContract(routerAddress, routerABI, library, account)
}
